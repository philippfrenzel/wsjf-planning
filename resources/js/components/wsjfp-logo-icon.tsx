...
export default function WSJFPLogoIcon(props: SVGAttributes<SVGElement>) {
    return (
        <svg {...props} viewBox="0 0 120 42" xmlns="http://www.w3.org/2000/svg">
            {/* W */}
            <path d="M16 8L12 34H8L5.5 17.5L3 34H-1L-5 8H0L2.5 27L5.5 8H9L12 27L14.5 8H16Z" transform="translate(12, 0)" fillRule="evenodd" />
            {/* S */}
            <path
            ...
            />
            {/* F */}
            <path d="M0 8H12V11H3V19H10V22H3V34H0V8Z" transform="translate(70, 0)" fillRule="evenodd" />
            {/* P */}
            <path
