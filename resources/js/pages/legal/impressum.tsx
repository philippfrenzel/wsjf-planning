            ...
            <div className="min-h-screen bg-[#f5f5f4] text-[#1b1b18] dark:bg-[#1e1e1e] dark:text-[#EDEDEC]">
                <div className="mx-auto flex min-h-screen w-full max-w-3xl flex-col gap-8 px-6 py-12">
                    <header className="space-y-2">
                        ...
                        <p className="text-sm text-[#706f6c] dark:text-[#A1A09A]">Angaben gemäß § 5 TMG sowie Art. 13 DSGVO.</p>
                    </header>
                    ...
                    <section className="space-y-3">
                        ...
                        <div className="space-y-1 text-sm text-[#1b1b18] dark:text-[#EDEDEC]">
                            ...
                            <p>
                                E-Mail:{' '}
                                <a href="mailto:philipp@frenzel.net" className="text-primary font-medium underline-offset-4 hover:underline">
                                    philipp@frenzel.net
                                </a>
                            </p>
                        </div>
                    ...
                    <section className="space-y-3">
                        ...
                        <p className="text-sm leading-relaxed text-[#3f3e3a] dark:text-[#C7C6C0]">
                            ...
                            verantwortlich. Nach §§ 8 bis 10 TMG bin ich jedoch nicht verpflichtet, übermittelte oder gespeicherte fremde
                    ...
                    <section className="space-y-3">
                        ...
                        <p className="text-sm leading-relaxed text-[#3f3e3a] dark:text-[#C7C6C0]">
                            Mein Angebot enthält Links zu externen Webseiten Dritter, auf deren Inhalte ich keinen Einfluss habe. Deshalb kann ich für
                            ...
                            oder Betreiber der Seiten verantwortlich. Bei Bekanntwerden von Rechtsverletzungen werde ich derartige Links umgehend
                            entfernen.
                        </p>
                    </section>
                    ...
                    <section className="space-y-3">
                        ...
                        <p className="text-sm leading-relaxed text-[#3f3e3a] dark:text-[#C7C6C0]">
                            Die Nutzung dieser Website ist in der Regel ohne Angabe personenbezogener Daten möglich. Soweit auf meinen Seiten
                            personenbezogene Daten (beispielsweise Name oder E-Mail-Adresse) erhoben werden, erfolgt dies stets auf freiwilliger
                            Basis. Die Daten werden ohne Ihre ausdrückliche Zustimmung nicht an Dritte weitergegeben. Es gelten die
                    ...
                    <section className="space-y-3">
                        ...
                        <p className="text-sm leading-relaxed text-[#3f3e3a] dark:text-[#C7C6C0]">
                            Bei Fragen zum Datenschutz oder zur Wahrnehmung Ihrer Rechte (Auskunft, Löschung, Widerruf) wenden Sie sich bitte an die
