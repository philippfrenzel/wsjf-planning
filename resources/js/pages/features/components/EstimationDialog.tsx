        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        {isEditing ? 'Bearbeiten Sie die Werte der ausgewählten Schätzung.' : 'Geben Sie die Werte für Ihre neue Schätzung ein.'}
                    </DialogDescription>
                </DialogHeader>
                <form onSubmit={onSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <Select value={estimationData.unit} onValueChange={onUnitChange}>
                            <SelectTrigger>
                    ...
                    <div>
                        ...
                        <Textarea id="notes" value={estimationData.notes} onChange={(e) => onNotesChange(e.target.value)} rows={3} />
                    </div>
