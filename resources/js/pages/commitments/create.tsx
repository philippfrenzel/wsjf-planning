...
export default function CreateCommitment({
    ...
    useEffect(() => {
        if (data.planning_id) {
            ...
            axios
                .post(route('api.planning-features'), {
    ...
    return (
        ...
        >
            <div className="py-6">
                <h1 className="mb-6 text-2xl font-bold">Neues Commitment erstellen</h1>
                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div>
                                ...
                                <Select value={data.planning_id} onValueChange={(value) => setData('planning_id', value)}>
                                    <SelectTrigger>
                                        ...
                                        {statusOptions.map((status) => (
                                            <SelectItem key={status.value} value={status.value}>
                                                <div className="flex items-center">
                                                    <span
                                                        className={`mr-2 inline-block h-3 w-3 rounded-full ${status.color.replace('bg-', 'bg-').replace('text-', '')}`}
                                                    />
                                                    {status.label}
                                                </div>
                                            </SelectItem>
                            ...
                            {/* Genereller Fehler */}
                            {generalError && (
                                <div className="my-4 border-l-4 border-red-500 bg-red-50 p-4">
