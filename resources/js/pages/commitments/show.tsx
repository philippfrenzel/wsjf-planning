  ...
  return (
    <AppLayout breadcrumbs={[
      ...
      <div className="py-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Commitment für {commitment.feature.jira_key}: {commitment.feature.name}</CardTitle>
          </CardHeader>
          <CardContent>
              ...
              <div className="space-y-1">
                ...
                <dd>
                  {commitment.status_details ? (
                    <Badge className={commitment.status_details.color}>
                      {commitment.status_details.name}
                    </Badge>
                  ) : (
