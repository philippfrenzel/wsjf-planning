                                ...
                                <div>
                                    ...
                                    {statusOptions.length > 1 && (
                                        <div className="mt-4">
                                            ...
                                            <Select value={values.new_status} onValueChange={(value) => handleSelectChange('new_status', value)}>
                                            ...
                                            {errors.new_status && <p className="mt-1 text-sm text-red-600">{errors.new_status}</p>}
                                        </div>
                                    )}
                                </div>
                            </div>
